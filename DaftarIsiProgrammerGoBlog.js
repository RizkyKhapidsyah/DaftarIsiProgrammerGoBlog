			...
			for (var h = 0; h < d; h++)
			{
				...
				if ("category" in n)
				{
					for (var g = 0; g < n.category.length; g++)
					{
						...
						postLabels[ii] = c;postTitle[ii] = e;
						postDate[ii] = m;postUrl[ii] = j;
						postMp3[ii] = o;
...
function hideToc()
{
	...
	showToc(); 
	Effect.toggle(\'toc-result\',\'blind\');">?? Menampilkan Daftar Isi</a> <img src="http://radiorodja.googlepages.com/new_1.gif"/>'
}
